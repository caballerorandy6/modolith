...
export const navbar = [
  { id: "hero", hash: "#hero", name: "Home" },
  { id: "about", hash: "#about", name: "About" },
  { id: "contact", hash: "#contact", name: "Contact" },
];
